<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="LabsManagementLabDetails.aspx.cs" Inherits="SuperAdmin_LabsManagementLabDetails" %>
...
//        pageSize: 10,
        ...
        filters: [false, true, 'select', true, false, true, false, false],
...
//        pageSize: 10,
        ...
        filters: [false, true, 'select', true, true, true,true, true],
        filterText: 'Type to filter... ',
        onChange: function (old_page, new_page) {
            console.log('changed from ' + old_page + ' to ' + new_page);
        }
