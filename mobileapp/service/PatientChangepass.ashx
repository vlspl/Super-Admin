<%@ WebHandler Language="C#" Class="PatientChangepass" %>
...
public class PatientChangepass : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        {
            case "UpdatePass":
                string PatientId = Convert.ToString(context.Request.QueryString["sPatientId"]);
                ...
                int i = selectpass(Contact, OldPass, PatientId, ConfPass);
