...
<%@ WebHandler Language="C#" Class="PatientMyProfile" %>
...
public class PatientMyProfile : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
                    ...
                    for (int j = 0; j < ds.Rows.Count; j++)
                    {
                        if (j == 0)
                        {
                           ...
                           sbData.Append("\"sFullName\":\"" + cGeneralHelper.JSONEscape(ds.Rows[j]["sFullName"].ToString()) + "\",");
                                ...
                                sbData.Append("\"sImagePath\":\"https://visionarylifescience.com/images/profileimage/" + cGeneralHelper.JSONEscape(ds.Rows[j]["sImagePath"].ToString()) + "\",");
