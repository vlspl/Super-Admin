...
public class index : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //    strsnm = context.Session["Username"].ToString();
        //context.Response.Write(strsnm);
        switch (Action)
        {
            case "Register":
            ...
            case "DocLogin":
                ...
                string UsernameDoc = Convert.ToString(context.Request.QueryString["Username"]);
                Password = Convert.ToString(context.Request.QueryString["Password"]);
                dt = GetLogin(UsernameDoc, Password);
                if (dt != null && dt.Rows.Count > 0)
                {
