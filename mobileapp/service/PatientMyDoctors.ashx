<%@ WebHandler Language="C#" Class="PatientMyDoctors" %>
...
public class PatientMyDoctors : IHttpHandler
{
    ...
    public DataTable GetLabData(string patientId)
    {
        try
        {
            string Query = "select md.sMyDoctorId,au.sAppUserId,au.sFullName,au.sMobile,au.sEmailId,au.sSpecialization  from myDoctors md join  appUser au on au.sAppuserId=md.sDoctorId where md.sPatientId ='" + patientId + "'";
