<%@ WebHandler Language="C#" Class="NotificationFromLab" %>
...
public class NotificationFromLab : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
        ...
        switch (Action)
        {
            case "GCMNotification":
                ...
                try
                {
                    ...
                    string MobMessage = Convert.ToString(context.Request.QueryString["sMobMessage"]);
                    ...
                    NotificationFromLab apnGCM = new NotificationFromLab();
                    response = apnGCM.SendGCMNotification1("AIzaSyAtIq9gFi4j_h3a41VfVntUY6whebQUglw", postData, deviceId, MobMessage);
    ...
    private string SendGCMNotification1(string apiKey, string postData1, string deviceId, string MobMessage, string postDataContentType = "application/json")
    {
        //--------------------------
        ...
        var value = MobMessage; //message text box                                                                               
