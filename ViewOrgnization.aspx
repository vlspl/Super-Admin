...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box-body" style="padding: 20px">
        <div class="col-sm-3">
              <div class="form-group">
                    ...
                    <asp:DropDownList ID="drpstatus"  class="form-control select2 select2-hidden-accessible"
                        runat="server" Style="width: 100%" AutoPostBack="True" OnSelectedIndexChanged="drpstatus_SelectedIndexChanged" >
        ...
        <asp:GridView ID="grdviewOrgnization" runat="server" DataKeyNames="ID"  CssClass="table table-bordered table-hover table-striped"
            ...
            OnSelectedIndexChanged="grdviewOrgnization_SelectedIndexChanged" OnRowDataBound="grdviewOrgnization_RowDataBound">
            <Columns>
