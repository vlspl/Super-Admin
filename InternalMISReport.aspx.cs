...
public partial class InternalMISReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            db.bindDrp("select rpt_Name from MISReportMaster", drpreportName, "rpt_Name", "rpt_Name");
    ...
    {
        string LabId = Request.Cookies["LabId"].Value.ToString();
        string spName = db.getData("select spName from MISReportMaster where rpt_Name='"+drpreportName.Text+"'").ToString();
