<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="TestBulkUpload_Labwise.aspx.cs" Inherits="SuperAdmin_TestBulkUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box-body" style="padding: 20px">
     ...
     <div class="form-group">
                   ...
                   <asp:ListItem>Induvisual Lab</asp:ListItem>
                    </asp:DropDownList>
                    </div>
                </div>
    </div>
