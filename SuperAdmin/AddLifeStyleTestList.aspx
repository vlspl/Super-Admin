<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="AddLifeStyleTestList.aspx.cs" Inherits="SuperAdmin_AddLifeStyleTestList" %>
               ...
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-sm-6 text-right">
                        <a href="ViewLifeStyleDesorderTestList.aspx"  class='lab-btn-white'><span class="fa fa-eye" aria-hidden="true"></span> View Test List</a>
                     </div>
                  </div>
               </div>
            </nav>
  <div class="box-body" style="padding:20px">
    ...
    <script type="text/javascript">
        function edit(testIddata) {
            $.ajax({
                url: "AddLifeStyleTestList.aspx/TestEdit",
