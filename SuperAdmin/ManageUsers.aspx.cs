    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
           ...
           // loadSuperAdminUsersList();
            ...
            //if (objLabUser.addSuperAdminUser(labId, labCode, fullname, emailId, contact, description, userName, password, role, roleId) == 1)
            //{
            //    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "insertSuccess", "alert('User Added successfully');location.href='ManageUsers.aspx';", true);
            //}
            //else if (objLabUser.addSuperAdminUser(labId, labCode, fullname, emailId, contact, description, userName, password, role, roleId) == 0)
            //{
            //    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "insertSuccess", "alert('Error Occured While Adding User');location.href='ManageUsers.aspx';", true);
            //}
