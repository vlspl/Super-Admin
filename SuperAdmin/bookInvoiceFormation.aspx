<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="bookInvoiceFormation.aspx.cs" Inherits="SuperAdmin_bookInvoiceFormation" %>
    ...
    <div class="container-fluid">
        ...
        <div class="labregister">
            ...
            <div class="header-wrap">
             <span style="color:Green;"><i class="fas fa-caret-right"></i>Booking Invoice Formation : </span>
               ...
               <br />
                <span style="color:Green;"><i class="fas fa-caret-right"></i> Booking Invoice Formation Details : </span>
                  <div class="row" style="margin-top:10px;">
