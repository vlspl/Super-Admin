<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master"
    AutoEventWireup="true" CodeFile="healthcampTestMaster.aspx.cs" Inherits="SuperAdmin_healthcampTestMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <nav class="primary-col-back subheader">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-sm-6">
                        <h4>Healthcamp Test Master</h4>
                     </div>
                      <div class="col-sm-6 text-right">
                        <a href="ViewOrgBranch.aspx"  class='lab-btn-white'><span class="fa fa-eye" aria-hidden="true"></span> View Test</a>
                     </div>
                  </div>
               </div>
            </nav>
