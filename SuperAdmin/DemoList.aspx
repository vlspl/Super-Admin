<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="DemoList.aspx.cs" Inherits="SuperAdmin_DemoList" %>
        ...
        <div id="content">
         ...
         <div class="col-lg-12">
              ...
              <div class="col-lg-2 col-md-2">
                ...
                <%-- <div class="col-lg-6">
                    <div class="form-group">
                          <asp:TextBox ID="txtFromDate" runat="server" placeholder="DemoDate" CssClass="form-control"></asp:TextBox>
                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFromDate" >
...
<%--            <div class="col-lg-2 col-md-2">
                 <div class="form-group">
                    ...
                    <asp:TextBox ID="txtToDate"  runat="server" Width="150px" type="text" Height="40px" TextMode="Date" ></asp:TextBox>
                </div>
     ...
     <asp:GridView ID="grdviewDemoList" runat="server" style="width:100%"
        ...
        --%>
                 <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server"   NavigateUrl='<%# string.Format("~/SuperAdmin/DemoRequestNew.aspx?requestId={0}",
