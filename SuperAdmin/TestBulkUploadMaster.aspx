<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="TestBulkUploadMaster.aspx.cs" Inherits="SuperAdmin_TestBulkUploadMaster" %>
...
--%>                <asp:BoundField DataField="testId" HeaderText="Test ID" />
                ...
                <asp:TemplateField>
                     <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" HeaderText= "Action"   NavigateUrl='<%# string.Format("~/SuperAdmin/TestBulkUploadMaster.aspx?testResultUploadId={0}",
