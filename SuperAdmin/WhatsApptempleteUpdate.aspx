<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="WhatsApptempleteUpdate.aspx.cs" Inherits="SuperAdmin_WhatsApptempleteUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="header-wrap"> 
       <sapn class="primary-col">View WhatsAppMaster details
 </sapn>
