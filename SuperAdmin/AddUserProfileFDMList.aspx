<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/accessControlMaster.master" AutoEventWireup="true" CodeFile="AddUserProfileFDMList.aspx.cs" Inherits="SuperAdmin_AddUserProfileFDMList" %>
...
<nav class="primary-col-back subheader">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-sm-6">
                        <h4>Add UserProfile FDM List</h4>
                     </div>
                      <div class="col-sm-6 text-right">
                       
                        <a href="FDMList.aspx"  class='lab-btn-white'><span class="fa fa-eye" aria-hidden="true"></span> View UserProfile FDM List</a>
                     </div>
