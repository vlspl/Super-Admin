<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="WhatsAppTempleteCreation.aspx.cs" Inherits="SuperAdmin_WhatsAppTempleteCreation" %>
            ...
            <div class="col-lg-6 col-md-6">
             ...
             <div class="col-lg-6 col-md-6">
                  <div class="form-group">
                   ...
                   <asp:TextBox runat="server" class="form-control" ID="txtMsgText"
                        required placeholder="Message Text"  MaxLength="100" TextMode="MultiLine" Width="500px"  />
                </div>
                 </div>
             ...
             <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" ClientIDMode="Static" class="form-control" MaxLength="2" ID="txtParameter" onkeypress="return isNumber(event)" 
  ...
  <asp:TemplateField HeaderText="Sr.No" ItemStyle-Width="30">
         ...
         <%-- <asp:BoundField DataField="body" HeaderText="Message Type" />  --%>
          ...
          <asp:BoundField DataField="approveBy" HeaderText="Approve By" />
                 ...
                 <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server"   NavigateUrl='<%# string.Format("WhatsApptempleteUpdate.aspx?whatsappMasterId={0}",
