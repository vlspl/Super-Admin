<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="TestBulkUpload.aspx.cs" Inherits="SuperAdmin_TestBulkUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div style="clear:both;"><br /></div>
       <asp:GridView ID="GridTestUpload" CssClass="table table-bordered table-striped table-hover "
            ...
            runat="server" AutoGenerateColumns="false"  DataKeyNames="testBuUploadId" 
            AllowPaging="True" onpageindexchanging="GridTestUpload_PageIndexChanging" >
