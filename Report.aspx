...
<body id="allpage" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-1">
            <asp:Button ID="btnprintReport" runat="server" CssClass="btn btn-color"  style="margin-left:-15px; margin-top:10px;"
                Text="Customize Report" onclick="btnprintReport_Click" />
        </div>
        <div class="col-lg-1">
        <asp:button ID="imgBtnPrint" style="margin-left:15px; margin-top:10px;"  CssClass="btn btn-color" runat="server" Text="Print"  onclick="imgBtnPrint_Click"  />
