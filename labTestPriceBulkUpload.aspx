<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="labTestPriceBulkUpload.aspx.cs" Inherits="SuperAdmin_labTestPriceBulkUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box-body" style="padding: 20px">
     ...
     <div class="form-group">
                    <label  class="control-label col-sm-4">Select Lab <span style="color:Red">* </span></label>
                        <div class="col-sm-8">
    ...
    <br />
     <div class="form-group">
                    <label  class="control-label col-sm-4">File <span style="color:Red">* </span></label>
                        <div class="col-sm-8">
                                      ...
                                      EmptyDataText="No Record Found"      runat="server" AutoGenerateColumns="false"  DataKeyNames="testUploadId" >
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="View Log">
                                                    <ItemTemplate>
                                                     <asp:LinkButton ID="lnkDownload" Text="Log" CommandArgument='<%# Eval("testUploadId") %>' runat="server" OnCommand="DownloadFile"></asp:LinkButton>
                                                  </ItemTemplate>
                                                </asp:TemplateField>
