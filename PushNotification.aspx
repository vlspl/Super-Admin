<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="PushNotification.aspx.cs" Inherits="SuperAdmin_PushNotifi" %>
  ...
  Push Notification
   ...
   <span style="font-size:18px;">No of Records : 
        ...
        <asp:GridView ID="griduserActivation" runat="server" DataKeyNames="sAppUserId"  CssClass="table table-bordered table-hover table-striped"
            ...
            onrowdatabound="griduserActivation_RowDataBound" >
            <Columns>
