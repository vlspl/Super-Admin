...
public partial class SuperAdmin_RoleMaster : System.Web.UI.Page
{
    ...
    protected void btnaddRole_Click(object sender, EventArgs e)
    {
        if (txtroleName.Text != "")
        {
            if (drpstatus.Text != "-Select Status-")
            {
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "insertSuccess", "alert('Select Role Status');", true);
            }
        }
        else
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "insertSuccess", "alert('Enter Role Name');", true);
        }
