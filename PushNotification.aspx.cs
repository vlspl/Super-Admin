...
public partial class SuperAdmin_PushNotifi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (true)//Request.Cookies["AdminId"].Value != null
        {
            if (!IsPostBack)
            {
                ...
                gridBind();
                db.bindDrp("select distinct sRole from appUser where sRole!='' ", drprole, "sRole", "sRole");
    ...
    protected void griduserActivation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        //    e.Row.Cells[2].Text = CryptoHelper.Decrypt(mobNo);
        //    e.Row.Cells[3].Text = CryptoHelper.Decrypt(emailId);
        //}
    }
}