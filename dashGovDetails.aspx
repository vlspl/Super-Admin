<%@ Page Title="" Language="C#" MasterPageFile="~/accessControlMaster.master" AutoEventWireup="true" CodeFile="dashGovDetails.aspx.cs" Inherits="SuperAdmin_dashGovDetails" %>
               ...
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-sm-6 text-right" >
                       <a  href="govDilldown.aspx" class="btn btn-danger" style="margin-right:60px;"><i class="fa fa-arrow-left"></i>Back</a>
                       </div>
...
<ul class="nav nav-tabs">
        ...
        <a  href="#1" data-toggle="tab">Organization`Details</a>
			...
			<li><a href="#2" data-toggle="tab">District Details</a>
			</li>
