...
var numberOfItems = $('#page .table-row').length; // Get total number of the items that should be paginated
var limitPerPage = 20; // Limit of items per each page
$('#page .table-row:gt(' + (limitPerPage -1) + ')').hide(); // Hide all items over page limits (e.g., 5th item, 6th item, etc.)
...
$(".pagination li.current-page").on("click", function() {
  ...
  if ($(this).hasClass('active')) {
    ...
    $("#page .table-row").hide(); // Hide all items in loop, this case, all the list groups
...
$("#next-page").on("click", function() {
  ...
  if (currentPage === totalPages) {
    ...
    $("#page .table-row").hide(); // Hide all items in the pagination loop
