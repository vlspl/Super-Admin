            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <asp:TextBox ID="txtpassword" style="width:297px; margin-left:39px;" CssClass="form-control" placeholder="Password" TextMode="Password" runat="server"></asp:TextBox>
              ...
              <div class="col-lg-8 col-md-6">
                 <div class="form-group">
                     <asp:GridView ID="gvorguser" runat="server" AutoGenerateColumns="False" style="width:90%;" DataKeyNames="ID" OnRowDataBound="gvorguser_RowDataBound">
...
<asp:BoundField DataField="Name" HeaderText="Name" ItemStyle-Width="200" />
  ...
  <asp:BoundField DataField="Password" HeaderText="Password"  ItemStyle-Width="200" />
